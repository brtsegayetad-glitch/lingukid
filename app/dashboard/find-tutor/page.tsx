...
export default function FindTutorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      {/* MOBILE HEADER - Fixed at top for App feel */}
        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <button 
              ...
              className="bg-yellow-400 border-2 border-black px-4 py-1 rounded-lg font-black uppercase text-[10px] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
            >
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        {showPackages ? (
          ...
          <div className="space-y-3">
            {tutors.map((tutor) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-xl mr-3 border-2 border-black">
                  🎓
                </div>
                ...
                <div className="text-right pl-2">
                  <p className="text-xs font-black">{tutor.hourly_rate} <span className="text-[8px]">ETB</span></p>
                  <div className={`mt-1 h-3 w-3 rounded-full border-2 border-black ml-auto ${selectedTutorId === tutor.id ? 'bg-blue-600' : 'bg-white'}`}></div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* STICKY BOTTOM BUTTON - Fixed for Thumb use */}
